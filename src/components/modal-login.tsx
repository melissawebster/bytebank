    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={close}>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
          ...
          >
            <DialogPanel className="w-full max-w-xl transform rounded-xl space-y-6 min-h-screen bg-gray-50 p-6 md:px-14 text-left align-middle shadow-xl transition-all">
              <button
                onClick={close}
