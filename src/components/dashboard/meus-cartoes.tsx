  ...
  return (
    <div className="relative flex flex-col items-center w-full rounded-md bg-gray-400 p-6 min-h-[400px]">
      <div className="w-full flex flex-col">
        <div className="text-xl mb-6">Meus Cartões</div>
        <div className="flex flex-col gap-y-6">
          {/* Cartao Fisico */}
          <div>
            <div className="mb-2">Cartão físico</div>
            <div className="flex flex-col md:flex-row gap-2">
              ...
              <div className="flex flex-col gap-y-2 w-full items-center">
                <OrangeButtonWhiteTxt className="w-full max-w-[300px]">Configurar</OrangeButtonWhiteTxt>
                <TransparentButtonOrangeTxt className="w-full max-w-[300px]">Bloquear</TransparentButtonOrangeTxt>
                <div className="text-xs">Função: Débito/Crédito</div>
              </div>
            </div>
          </div>
          {/* Cartao Digital */}
          <div>
            <div className="mb-2">Cartão digital</div>
            <div className="flex flex-col md:flex-row gap-2">
              <Image 
              ...
              <div className="flex flex-col gap-y-2 w-full items-center">
                <OrangeButtonWhiteTxt className="w-full max-w-[300px]">Configurar</OrangeButtonWhiteTxt>
                <TransparentButtonOrangeTxt className="w-full max-w-[300px]">Bloquear</TransparentButtonOrangeTxt>
                <div className="text-xs">Função: Débito</div>
              </div>
            </div>
          </div>
        </div>
