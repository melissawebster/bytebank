...
import { blueCardStyle, whiteTextStyle } from "../components/shared";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="xl:mx-20 pt-4 px-6 mt-[4rem] pb-[60px] flex flex-col flex-1">
        <div className={`${blueCardStyle} mx-auto flex flex-col items-center w-full md:w-1/2 text-sm px-4 py-6 gap-y-4 mt-[30px]`}>
